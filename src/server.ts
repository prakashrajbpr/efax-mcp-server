...
async function main(): Promise<void> {
  try {
    ...
    try {
      console.log("🔄 Importing uploadToGCS...");
      ...
      console.log("✅ uploadToGCS imported successfully");
    } catch (error) {
      console.error("❌ Failed to import uploadToGCS:", error);
      console.error("💡 Check if file exists at one of these locations:");
    ...
    try {
      console.log("🔄 Importing extractTextFromPdfInCloud...");
      ...
      console.log("✅ extractTextFromPdfInCloud imported successfully");
    } catch (error) {
      console.error("❌ Failed to import cloudOCR:", error);
      console.error("💡 Check if file exists at one of these locations:");
    ...
    try {
      console.log("🔄 Importing mapToFHIR...");
      ...
      console.log("✅ mapToFHIR imported successfully");
    } catch (error) {
      console.error("❌ Failed to import mapToFHIR:", error);
      console.error("💡 Check if file exists at one of these locations:");
